...
export function TokenKindToString(kind: SyntaxKind): string
{
    switch (kind) {
...
export function GetKeywordForIdentifier(identifier: string): SyntaxKind
{
    switch (identifier) {
        case TokenKindToString(SyntaxKind.CharKeyword):
            return SyntaxKind.CharKeyword
        case TokenKindToString(SyntaxKind.ByteKeyword):
            return SyntaxKind.ByteKeyword
        case TokenKindToString(SyntaxKind.ShortKeyword):
            return SyntaxKind.ShortKeyword
        case TokenKindToString(SyntaxKind.IntKeyword):
            return SyntaxKind.IntKeyword
        case TokenKindToString(SyntaxKind.LongKeyword):
            return SyntaxKind.LongKeyword
        case TokenKindToString(SyntaxKind.VoidKeyword):
            return SyntaxKind.VoidKeyword
        case TokenKindToString(SyntaxKind.NullKeyword):
            return SyntaxKind.NullKeyword
        case TokenKindToString(SyntaxKind.CStringKeyword):
            return SyntaxKind.CStringKeyword
        case TokenKindToString(SyntaxKind.BoolKeyword):
            return SyntaxKind.BoolKeyword
        case TokenKindToString(SyntaxKind.TrueKeyword):
            return SyntaxKind.TrueKeyword
        case TokenKindToString(SyntaxKind.FalseKeyword):
            return SyntaxKind.FalseKeyword

        case TokenKindToString(SyntaxKind.IfKeyword):
            return SyntaxKind.IfKeyword
        case TokenKindToString(SyntaxKind.ElseKeyword):
            return SyntaxKind.ElseKeyword
        case TokenKindToString(SyntaxKind.DoKeyword):
            return SyntaxKind.DoKeyword
        case TokenKindToString(SyntaxKind.WhileKeyword):
            return SyntaxKind.WhileKeyword
        case TokenKindToString(SyntaxKind.ForKeyword):
            return SyntaxKind.ForKeyword
        case TokenKindToString(SyntaxKind.ReturnKeyword):
            return SyntaxKind.ReturnKeyword
        case TokenKindToString(SyntaxKind.BreakKeyword):
            return SyntaxKind.BreakKeyword
        case TokenKindToString(SyntaxKind.ContinueKeyword):
            return SyntaxKind.ContinueKeyword
        case TokenKindToString(SyntaxKind.SwitchKeyword):
            return SyntaxKind.SwitchKeyword
        case TokenKindToString(SyntaxKind.CaseKeyword):
            return SyntaxKind.CaseKeyword
        case TokenKindToString(SyntaxKind.DefaultKeyword):
            return SyntaxKind.DefaultKeyword
        case TokenKindToString(SyntaxKind.AsKeyword):
            return SyntaxKind.AsKeyword
        case TokenKindToString(SyntaxKind.SizeOfKeyword):
            return SyntaxKind.SizeOfKeyword

        case TokenKindToString(SyntaxKind.FunKeyword):
            return SyntaxKind.FunKeyword
        case TokenKindToString(SyntaxKind.LetKeyword):
            return SyntaxKind.LetKeyword
        case TokenKindToString(SyntaxKind.LetLocalPersistKeyword):
            return SyntaxKind.LetLocalPersistKeyword
        case TokenKindToString(SyntaxKind.StructKeyword):
            return SyntaxKind.StructKeyword
        case TokenKindToString(SyntaxKind.UnionKeyword):
            return SyntaxKind.UnionKeyword
        case TokenKindToString(SyntaxKind.EnumKeyword):
            return SyntaxKind.EnumKeyword
        case TokenKindToString(SyntaxKind.ClassKeyword):
            return SyntaxKind.ClassKeyword

        case TokenKindToString(SyntaxKind.ImportKeyword):
            return SyntaxKind.ImportKeyword
        case TokenKindToString(SyntaxKind.ExternKeyword):
...
export abstract class SyntaxNode
{
    ...
    PrettyPrint(indent = "", isLast = true)
    {
        let result = ""
        ...
        if (this instanceof SyntaxToken) {
            ...
            for (let trivia of token.leadingTrivia) {
                result += indent
                result += "├──"
                result += `L: ${trivia.kind}\n`
            }

            hasTrailingTrivia = token.trailingTrivia.length != 0
        }
